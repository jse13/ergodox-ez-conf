 ...
 */
  ...
  [0] = LAYOUT_ergodox(
    ...
    KC_TAB,             KC_Q,    KC_W,           KC_E,           KC_R, KC_T,  LSFT( LALT( KC_F5 ) ),
    KC_ESCAPE,          KC_A,    KC_S,           KC_D,           KC_F, KC_G,/*[#####]*/
    TD( TD_LSFT_CAPS ), KC_Z,    KC_X,           KC_C,           KC_V, KC_B,  KC_LABK,
      KC_LCTL, KC_LALT, KC_TRANSPARENT, KC_TRANSPARENT, MO(1),
                                                               LCTL(LSFT(KC_B)),           LCTL( KC_F17 ),
                                                  /*[#######]  [###################]*/     LCTL( KC_F18 ),
                                                    KC_BSPACE, TD( TD_WIN_CTRL_ALT ),      LCTL( KC_F19 ),

    KC_TRANSPARENT, KC_6,           KC_7,           KC_8,           KC_9,           KC_0,      KC_EQUAL,
    LALT( KC_F5 ), KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,      KC_BSLASH,
    /*[#####]*/     KC_H,           KC_J,           KC_K,           KC_L,           KC_SCOLON, KC_QUOTE,
      KC_RABK,      KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,  KC_RSHIFT,
