...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, LALT( KC_F4 ), LALT( KC_F5 ), LSFT( LALT( KC_F5 ) ), LSFT( LALT( KC_F4 ) )
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______,       _______,         _______,          _______,           _______, _______, _______, _______, _______, _______, _______,
    _______, _______,       _______,         _______,          NAV,           _______, _______, _______, _______, _______, _______, _______
),
